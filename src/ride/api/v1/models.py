...
class Ride(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=['pickup_latitude', 'pickup_longitude'], name='ride_pickup_coords'),
            models.Index(
                fields=['dropoff_latitude', 'dropoff_longitude'], name='ride_dropoff_coords'),
        ]
...
class Ride_Event(models.Model):
    ...
    id_ride_event = models.AutoField(
        primary_key=True, db_column='id_ride_event')
